...
export const dynamic = "force-dynamic"; // ✅ يمنع محاولة التوليد الثابت عند البناء
    ...
    <>
      ...
      <main className="pt-20">
        ...
        <section className="py-8 bg-gray-800 border-b border-gray-700">
          <div className="container mx-auto px-3 flex flex-col lg:flex-row gap-6 items-center">
          ...
          <div className="container mx-auto px-3">
            {filteredCourses.length === 0 ? (
              <div className="text-center py-16">
                <i className="fas fa-search text-6xl text-gray-600 mb-4" />
                    ...
                    <div className="p-6">
                      ...
                      <div className="space-y-2 mb-6">
                        <div className="flex items-center text-sm text-gray-300">
                          <i className="fas fa-calendar-alt w-4 ml-2" />
                          {formatDate(course.date)}
                        </div>
                        <div className="flex items-center text-sm text-gray-300">
                          <i className="fas fa-clock w-4 ml-2" />
                          {course.duration}
                        </div>
                        <div className="flex items-center text-sm text-gray-300">
                          <i className="fas fa-map-marker-alt w-4 ml-2" />
                          {course.city}
                        </div>
                      </div>
